...
export default class ErrorBoundary extends Component<Props, State> {
  ...
  render() {
    ...
    return (
      <div className="min-h-screen flex items-center justify-center bg-surface p-6" dir="rtl">
        <div className="max-w-md w-full bg-white rounded-2xl shadow-lg border border-outline/20 p-6 text-center">
          ...
          <h1 className="text-lg font-bold text-ink mb-1">משהו השתבש</h1>
          ...
          <details className="text-start text-xs text-ink-muted bg-surface-container-low rounded-lg p-2">
            <summary className="cursor-pointer select-none">פרטים טכניים (לדיווח)</summary>
